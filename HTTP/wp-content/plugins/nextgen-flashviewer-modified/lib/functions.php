...
function nggShowElleViewer($galleryID, $irWidth=null, $irHeight=null, $link = false) {
	...
	$swfobject = new swfobject( NGGFLASH_SWF_PATH.'elleviewer.swf', $obj, $irWidth, $irHeight, '9.0.0', 'false');
	
	
	// return "<textarea rows='15' cols='100'>" . $swfobject->javascript() . "</textarea>";
	...
	$swfobject->add_attributes('styleclass', 'elleviewer');
	...
	$swfobject->add_flashvars( 'xmlDataPath', NGGFLASHVIEWER_URLPATH.'xml/elleviewer.php?gid='.$galleryID );

	$out = "\n".'<div class="elleviewer" id="ngg_elleviewer'.$galleryID.'">';
	...
	// add swffit
	$out .= "\nswffit.fit('" . $obj . "_1', 900, 650);";//, maxWid, maxHei, hCenter, vCenter
	
	
	$out .= "\n".'</script>';
	
	$out .= '<style type="text/css" media="screen">object#'.$obj.'_1 {position:relative!important;}</style>';
