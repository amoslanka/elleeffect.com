...
<?php the_post() ?>
			...
			<div class="subheading"><?php if ( !(''== $authordata->user_description) ) : echo apply_filters('archive_meta', $authordata->user_description); endif; ?></div>
...
<?php edit_post_link(__('Edit', 'sandbox'), "\t\t\t\t\t<span class=\"edit-link\">", "</span>\n\t\t\t\t\t<span class=\"meta-sep\"> </span>\n"); ?>
					<span class="comments-link">Comments<?php comments_popup_link(__('(0)', 'sandbox'), __('(1)', 'sandbox'), __('(%)', 'sandbox')) ?></span>
				</div>
			</div><!-- .post -->
