				...
				<?php the_content(); ?>
							...
							<form method="post" action="<?php echo "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>" id="contactform">
								...
								<fieldset>
									...
									<textarea id="cp_message" name="cp_message" cols="65" rows="10"><?php echo $cp_message ;?></textarea><br/>
				...
				<!-- <?php trackback_rdf(); ?> -->
					...
					<?php
						...
						if (@mail(get_settings('admin_email'), $email_subject, $email_text, $header)) {
							echo "<h2>Hey " . $displayName . ",</h2><p>thanks for your message! I'll get back to you as soon as possible.</p></div>";
						}
					}
					?>
